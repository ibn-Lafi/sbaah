...
alter table units add constraint units_phase_same_tenant foreign key(phase_id,tenant_id) references project_phases(id,tenant_id) on delete set null;
...
alter table crm_tasks add constraint crm_tasks_assignee_same_tenant foreign key(assigned_user_id,tenant_id) references users(id,tenant_id) on delete set null;
...
alter table viewings add constraint viewings_property_same_tenant foreign key(property_id,tenant_id) references properties(id,tenant_id) on delete set null;
alter table viewings add constraint viewings_unit_same_tenant foreign key(unit_id,tenant_id) references units(id,tenant_id) on delete set null;
...
alter table deals add constraint deals_property_same_tenant foreign key(property_id,tenant_id) references properties(id,tenant_id) on delete set null;
alter table deals add constraint deals_unit_same_tenant foreign key(unit_id,tenant_id) references units(id,tenant_id) on delete set null;
alter table deals add constraint deals_responsible_same_tenant foreign key(responsible_user_id,tenant_id) references users(id,tenant_id) on delete set null;

alter table properties add constraint properties_marketing_mandate_same_tenant foreign key(marketing_mandate_id,tenant_id) references marketing_mandates(id,tenant_id) on delete set null;
