...
-- public_project_detail is intentionally redefined by the deployed database migration to return categorized project and asset media.\n-- Keep this schema migration paired with the API/public-site changes in this commit series.
