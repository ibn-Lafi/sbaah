...
export default function ConsoleHomePage(){
 ...
 return <ConsoleShell title="نظرة عامة">
  <div className="mb-6"><h1 className="text-2xl font-semibold text-text-primary">إدارة منصة سبعة</h1><p className="mt-1 text-sm text-text-secondary">متابعة تشغيل المنصة والعملاء والمحتوى من مكان واحد.</p></div>
