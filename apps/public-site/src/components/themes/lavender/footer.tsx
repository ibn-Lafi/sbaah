    ...
    <footer id="contact" className="bg-tenant-primary text-white">
      <div className="mx-auto w-full max-w-7xl px-6 py-12 sm:px-8 sm:py-14 lg:px-10 lg:py-16">
        ...
        <div className="mt-10 border-t border-white/15 pt-6 text-sm text-white/55">
          <div className="flex items-center justify-center gap-5"><a href={locale==='ar'?'/en':'/'} className="font-semibold text-white">{locale==='ar'?'English':'العربية'}</a><SiteBadge accountType={tenant.account_type} locale={locale}/></div>
