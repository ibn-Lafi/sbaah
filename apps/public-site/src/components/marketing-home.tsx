  ...
  return (
    <section className="w-full bg-surface-card py-8 sm:py-10">
      ...
      <div className="mx-auto mt-5 flex w-full max-w-3xl items-center justify-center gap-2 px-4 sm:gap-3">
        ...
        <a href={`/${locale}/support`} className="bg-brand inline-flex h-9 flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl px-2 text-[11px] font-semibold text-white transition-colors hover:bg-brand/90 sm:flex-none sm:px-5 sm:text-sm"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 flex-none" aria-hidden="true"><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3h11A2.5 2.5 0 0 1 20 5.5v8a2.5 2.5 0 0 1-2.5 2.5H10l-5 4v-4.5A2.5 2.5 0 0 1 4 13.5Z"/><path d="M8 8h8M8 12h5"/></svg>{locale === 'ar' ? 'مركز الدعم' : 'Support Center'}</a>
