...
const testimonials = {
  ar: [
    { kind:'company' as Kind, category:'developer', name:'روّاد العقارية', person:'م. عبدالله الشهراني', role:'الرئيس التنفيذي', logo:'/9DCD602D-DD02-4A73-AFF4-C94A48A71390.png', quote:'منذ اعتمادنا على سبعة، أصبح عرض مشاريعنا وتنظيم العملاء في مكان واحد أسهل بكثير، ووفّر علينا وقتًا في المتابعة اليومية.' },
  ...
  en: [
    { kind:'company' as Kind, category:'developer', name:'Ruwad Real Estate', person:'Abdullah Alshahrani', role:'CEO', logo:'/9DCD602D-DD02-4A73-AFF4-C94A48A71390.png', quote:'Sbaah brought our project showcase and client follow-up into one place, making daily operations much easier to organize.' },
