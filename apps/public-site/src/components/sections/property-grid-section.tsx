...
import type { PropertyGridSectionConfig } from '@sbaah/shared';
...
export async function PropertyGridSection({ locale, config }: { locale: Locale; config: PropertyGridSectionConfig }) {
