...
export default async function ProjectDetailPage({ params }: PageProps) {
  ...
  return <main className="pb-16">
    ...
    <div className="mx-auto max-w-6xl px-6">
      ...
      {tenantResult.status==='active'&&<section className="border-t border-black/10 py-10"><h2 className="mb-5 text-2xl font-semibold">{locale==='ar'?'سجل اهتمامك بالمشروع':'Register your interest'}</h2><InquiryForm locale={locale} tenantId={tenantResult.site.tenant.id} projectId={project.id}/></section>}
