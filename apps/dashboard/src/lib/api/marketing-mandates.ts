...
export const updateMarketingMandate=(token:string,id:string,input:MarketingMandateUpdateInput)=>apiPatch<{mandate:MarketingMandateV2}>(`/v1/marketing-mandates/${id}`,input,token);
