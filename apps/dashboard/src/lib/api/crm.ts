...
export interface CrmTask { id:string; lead_id:string|null; assigned_user_id:string|null; title:string; due_at:string|null; completed_at:string|null; completion_notes:string|null; }
