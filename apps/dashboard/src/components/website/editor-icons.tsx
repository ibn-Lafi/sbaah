...
const SECTION_TYPE_ICONS: Record<WebsiteSectionType, (props: IconProps) => React.ReactNode> = {
  ...
  featured_properties: GridSectionIcon,
  latest_properties: GridSectionIcon,
  project_grid: GridSectionIcon,
  projects_showcase: GridSectionIcon,
  properties_by_city: LocationIcon,
  stats: GridSectionIcon,
  services: StarSectionIcon,
  faq: InfoSectionIcon,
  cta: CallIcon,
  property_request: DocumentSectionIcon,
  promo_banner: StarSectionIcon,
  free_content: DocumentSectionIcon,
