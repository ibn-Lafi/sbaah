...
export const EDITABLE_TYPES: WebsiteSection['type'][] = ['hero', 'about', 'why_us', 'contact', 'featured_properties', 'latest_properties', 'projects_showcase', 'properties_by_city', 'stats', 'services', 'faq', 'cta', 'promo_banner', 'free_content', 'gallery', 'video'];
