...
/** إدارة الموظفين — نُقلت من مسار /team المستقل إلى محتوى قابل لإعادة الاستخدام يُعرض أيضًا داخل تبويب "الموظفين" بصفحة الإعدادات الموحّدة (/team يبقى يعمل، يعرض نفس المكوّن). */
