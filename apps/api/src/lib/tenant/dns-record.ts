/** PRODUCT_SPEC section 4.3: the CNAME target is a deployment-time value (task 42/42's Railway guide), never hardcoded. Shared by the owner-facing /v1/tenant/domain and console's review screen (task 40/42) so both show the exact same expected record. */
