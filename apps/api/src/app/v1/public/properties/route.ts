...
export const GET=withErrorHandling(async(request:NextRequest)=>{
 ...
 type PublicListingFeedRow = { listing_id:string; asset_slug?:string|null; listing_number:string; title_ar:string; title_en?:string|null; description_ar?:string|null; description_en?:string|null; asset_type:string; listing_type:string; asking_price:number|null; city_id?:string|null; district_id?:string|null; bedrooms?:number|null; bathrooms?:number|null; area_sqm?:number|null; advertisement_license_number?:string|null; advertiser_name?:string|null; created_at:string; asset_media?:unknown[]; pricing_period?:string|null; commercial_status:string; asset_id:string; lat?:number|null; lng?:number|null; total_count?:number|string|null };
 ...
 const properties=rows.map(r=>({
  ...
  commercial_status:r.commercial_status,asset_id:r.asset_id,lat:r.lat,lng:r.lng
 }));
