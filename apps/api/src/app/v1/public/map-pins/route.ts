...
type FeedRow = { listing_id:string; listing_number:string; listing_type:string; title_ar:string; title_en?:string|null; asking_price:number|null; asset_id:string; asset_slug?:string|null; asset_type:string; city_id?:string|null; district_id?:string|null; bedrooms?:number|null; bathrooms?:number|null; area_sqm?:number|null; asset_media?:unknown[]; lat?:number|null; lng?:number|null; };
